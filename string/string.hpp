...
public:
    ...
    int     getStringSize() const {return stringSize;};     // testing only
    ...
    int     toInt         ();                               // convert this string to integer
    std::vector<String> split(char) const; // return a vector of String split up based on a supplied character.
