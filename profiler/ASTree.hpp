...
public:
                  ...
                  AST       (nodes t, const std::string&, std::list<AST*>);
                 ~AST      ();
                  AST       (const AST&);
    void          swap      (AST&);
    AST&          operator= (AST);
    ...
    void          addFuncCount(std::list<AST*>::iterator, std::string, std::string);
  void          addCount(std::list<AST*>::iterator, std::string, std::string, std::string);
    ...
    void          condCount (const std::string&);
